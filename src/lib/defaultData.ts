    ...
    packages: [
      {
        ...
        period: "3 days",
        icon: "Package",
        description: "Quick island getaway with all essentials. Perfect for a short escape.",
        features: [
          { id: uid("pf"), text: "3 nights accommodation in any room type" },
          { id: uid("pf"), text: "Daily breakfast at beachfront cafe" },
          { id: uid("pf"), text: "1 island hopping tour" },
        ...
        includedTourIds: [],
        includeMotorbike: true,
        includeAirportTransfer: true,
        dailyCoffeeCount: 1,
        dailyMealCount: 1,
        buttonLabel: "Book 3-Day Package",
        featured: false,
        order: 0,
      },
      {
        id: uid("pkg"),
        name: "7-Day All-Inclusive",
        price: 28500,
        priceTwo: 25500,
        period: "7 days",
        icon: "Package",
        description: "Complete resort stay with all essentials included. Just bring yourself.",
        features: [
          { id: uid("pf"), text: "7 nights accommodation in any room type" },
          { id: uid("pf"), text: "Daily breakfast at beachfront cafe" },
        ...
        dailyCoffeeCount: 1,
        dailyMealCount: 1,
        buttonLabel: "Book 7-Day Package",
        featured: true,
        order: 1,
      },
      {
        id: uid("pkg"),
        name: "15-Day All-Inclusive",
        price: 52000,
        priceTwo: 46000,
        period: "15 days",
        icon: "Package",
        description: "Extended stay for deep work. Full resort access with premium perks.",
        features: [
          { id: uid("pf"), text: "15 nights accommodation in any room type" },
          { id: uid("pf"), text: "Daily breakfast at beachfront cafe" },
          { id: uid("pf"), text: "5 island hopping tours selected for you" },
          { id: uid("pf"), text: "Unlimited motorbike rental" },
          { id: uid("pf"), text: "San Vicente Airport transfer both ways" },
          { id: uid("pf"), text: "Daily coffee credit" },
          { id: uid("pf"), text: "Weekly laundry service" },
          { id: uid("pf"), text: "Welcome dinner for two" },
        ],
        includedTourIds: [],
        includeMotorbike: true,
        includeAirportTransfer: true,
        dailyCoffeeCount: 1,
        dailyMealCount: 1,
        buttonLabel: "Book 15-Day Package",
        featured: false,
        order: 2,
      },
    ],
...
export function buildDefaultOperations(): import("@/types/cms").Operations {
  ...
  return {
    ...
    menuItems: [
      // ── Breakfast ──
      { id: uid("mi"), name: "Corned Beef with Eggs", description: "Corned beef served with two eggs and a choice of plain rice or toasted bread", category: "breakfast", price: 350, foodCost: 120, inventoryCount: 20, active: true, order: 0 },
      { id: uid("mi"), name: "French Toast", description: "Custard-soaked bread, gently caramelized and served with maple syrup and whipped cream", category: "breakfast", price: 300, foodCost: 90, inventoryCount: 20, active: true, order: 1 },
      { id: uid("mi"), name: "Pancakes with Fruit or Chocolate Chips", description: "Fluffy pancakes topped with fruit or chocolate chips, whipped cream, and maple syrup", category: "breakfast", price: 350, foodCost: 100, inventoryCount: 20, active: true, order: 2 },
      { id: uid("mi"), name: "Cheese Omelette", description: "Fluffy omelette filled with Italian cheese and served with buttery toasted bread", category: "breakfast", price: 400, foodCost: 110, inventoryCount: 20, active: true, order: 3 },
      { id: uid("mi"), name: "Tropical Yogurt Bowl", description: "Creamy yogurt topped with granola, honey, and seasonal island fruits", category: "breakfast", price: 320, foodCost: 85, inventoryCount: 20, active: true, order: 4 },
      // ── Lunch ──
      { id: uid("mi"), name: "Bruschetta", description: "Toasted rustic bread topped with fresh tomatoes, basil, garlic, and olive oil", category: "lunch", price: 320, foodCost: 90, inventoryCount: 20, active: true, order: 5 },
      { id: uid("mi"), name: "Papas Bravas", description: "Crispy potatoes served with spicy brava sauce and garlic aioli", category: "lunch", price: 300, foodCost: 75, inventoryCount: 20, active: true, order: 6 },
      { id: uid("mi"), name: "Linguine Aglio, Olio e Peperoncino", description: "Linguine tossed with garlic, olive oil, chili, and Parmesan cheese", category: "lunch", price: 480, foodCost: 130, inventoryCount: 20, active: true, order: 7 },
      { id: uid("mi"), name: "Tagliatelle Puttanesca", description: "Ribbon pasta served with a tomato sauce containing olives, capers, garlic, and chili", category: "lunch", price: 550, foodCost: 150, inventoryCount: 20, active: true, order: 8 },
      { id: uid("mi"), name: "Tonkatsu Pork Curry", description: "Crispy breaded pork cutlet served with rich Japanese-style curry and rice", category: "lunch", price: 550, foodCost: 160, inventoryCount: 20, active: true, order: 9 },
      // ── Dinner ──
      { id: uid("mi"), name: "Shrimp Marinara Linguine", description: "Linguine tossed in tomato marinara sauce with sautéed shrimp", category: "dinner", price: 650, foodCost: 200, inventoryCount: 20, active: true, order: 10 },
      { id: uid("mi"), name: "Shrimp à la Pobre", description: "Garlic-sautéed shrimp served with rustic potatoes and caramelized onions", category: "dinner", price: 650, foodCost: 210, inventoryCount: 20, active: true, order: 11 },
      { id: uid("mi"), name: "Mojo Verde Fish Fillet", description: "Grilled fish fillet served with a fresh green herb sauce", category: "dinner", price: 650, foodCost: 190, inventoryCount: 20, active: true, order: 12 },
      { id: uid("mi"), name: "Chicken Cacciatore", description: "Chicken braised with tomatoes, herbs, bell peppers, and olives", category: "dinner", price: 600, foodCost: 170, inventoryCount: 20, active: true, order: 13 },
      { id: uid("mi"), name: "Paccheri Carbonara", description: "Large tube pasta served in a creamy sauce with egg, cheese, and cured meat", category: "dinner", price: 700, foodCost: 180, inventoryCount: 20, active: true, order: 14 },
      // ── Drinks ──
      { id: uid("mi"), name: "Bottled Water", description: "500ml purified water", category: "drinks", price: 25, foodCost: 8, inventoryCount: 50, active: true, order: 15 },
      { id: uid("mi"), name: "Coca-Cola / Sprite", description: "330ml can", category: "drinks", price: 35, foodCost: 12, inventoryCount: 50, active: true, order: 16 },
      { id: uid("mi"), name: "Fresh Buko Juice", description: "Young coconut, natural sweetness", category: "drinks", price: 60, foodCost: 20, inventoryCount: 30, active: true, order: 17 },
      { id: uid("mi"), name: "Iced Tea", description: "House-brewed, lightly sweetened", category: "drinks", price: 50, foodCost: 10, inventoryCount: 40, active: true, order: 18 },
      { id: uid("mi"), name: "San Miguel Beer", description: "Pale Pilsen 330ml", category: "drinks", price: 70, foodCost: 25, inventoryCount: 50, active: true, order: 19 },
      { id: uid("mi"), name: "Mango Shake", description: "Fresh mango blended with ice", category: "drinks", price: 90, foodCost: 30, inventoryCount: 30, active: true, order: 20 },
    ],
    foodOrders: [],
    guestMessages: [],
  };
