...
export function PackagesSection() {
  ...
  return (
    <section id="packages" className="bg-[#FAF6EF] py-24 lg:py-32">
      <div className="mx-auto max-w-[1400px] px-6 lg:px-12">
        <Reveal className="mx-auto max-w-xl text-center">
          <p className="mb-3 text-xs font-semibold uppercase tracking-[0.25em] text-[#C6A15B]">All-Inclusive Packages</p>
          <h2 className="font-serif text-4xl font-light leading-[1.1] text-[#26221C] sm:text-5l">Everything You Need, One Price</h2>
          <p className="mt-4 text-[#26221C]/60">Skip the planning. Our packages bundle accommodation, tours, meals, and transport so you can focus on what matters.</p>
        </Reveal>
