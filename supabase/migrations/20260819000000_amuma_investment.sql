...
VALUES
  ...
  ('investment', 'AMUMA offers four investment tiers: Nova (₱500,000 — 50 Units — 1,000 Pebbles), Aurora (₱1,200,000 — 120 Units — 2,200 Pebbles), Orion (₱2,000,000 — 210 Units — 4,000 Pebbles), Polaris (₱4,000,000 — 440 Units — 8,000 Pebbles).'),
  ('investment', 'The Founding Circle is limited to 20 Nova spots at ₱500,000 each. Founding Circle members get 50 units (1.79% ownership), 1,000 annual Pebbles, early access to future retreats, name on the founding plaque, and an invitation to the annual Founders Dinner.'),
  ('investment', 'Projected annual ROI for Circle Members is 17–20%, based on conservative 55% occupancy assumptions. A Nova investor can expect ~₱85,000–₱100,000 annual return on a ₱500,000 investment.'),
  ('investment', 'Pebbles is AMUMA internal lifestyle currency. Members receive Pebbles annually to spend on suite nights, dining, excursions, boat trips, and spa treatments. Suites cost 150–300 Pebbles/night, Villas 275–500 Pebbles/night depending on season.'),
  ...
  ('investment', 'Founding team: Giacomo Gervasutti (Founder & Vision Director — owns Baia Boutique Resort and Marina Terrace), Irina Feleo (Cofounder & Creative Director), Joaquin Esquivias (Chief Legal & Strategy Officer).'),
  ('investment', 'The Member Portal webapp lets members reserve suites with Pebbles, book experiences, track Pebble balance and profits, send/receive Pebble gifts, message resort staff, and vote on club decisions.'),
